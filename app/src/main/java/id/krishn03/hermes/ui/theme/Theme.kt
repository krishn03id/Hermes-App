...
private val DarkColors = darkColorScheme(
    ...
    onBackground = Color(0xFFE7E5DE),
    surface = Color(0xFF262624),
    onSurface = Color(0xFFE7E5DE),
    surfaceVariant = Color(0xFF34322F),
    onSurfaceVariant = Color(0xFFB6B2A8),
    surfaceContainer = Color(0xFF2F2E2B),
    surfaceContainerHigh = Color(0xFF39372F),
    outline = Color(0xFF4A4842),
    outlineVariant = Color(0xFF3A3833),
    secondaryContainer = Color(0xFF39372F),
    onSecondaryContainer = Color(0xFFE7E5DE),
